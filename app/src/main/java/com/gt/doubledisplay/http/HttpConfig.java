...
public class HttpConfig {
   ...
   // public static final String BASE_URL = "http://nb.yj.deeptel.com.cn/";
    ...
    //正式
    public static final String DUOFRIEND_LOGIN="http://canyin.duofriend.com/";
    //堡垒
    //public static final String DUOFRIEND_LOGIN="http://nb.canyin.deeptel.com.cn/";
    //测试
   ...
   // public static final String SOCKET_ANDROID_AUTH_KEY = "doubleScreen_socket";
    ...
    public static final String DOUBLE_URL="http://192.168.3.39:8091/views/Slide/list.html";
