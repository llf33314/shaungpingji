 ...
 * Original file: E:\\duofen\\MagicBoxApp\\app\\src\\main\\aidl\\com\\gt\\magicbox\\GpService.aidl
 */
package com.gprinter.aidl;
public interface GpService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements GpService
{
private static final String DESCRIPTOR = "com.gt.magicbox.GpService";
...
/**
 * Cast an IBinder object into an com.gt.magicbox.GpService interface,
 * generating a proxy if needed.
 */
public static GpService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof GpService))) {
return ((GpService)iin);
}
...
{
data.enforceInterface(DESCRIPTOR);
String _result = this.getClientID();
reply.writeNoException();
...
private static class Proxy implements GpService
{
...
@Override public int openPort(int PrinterId, int PortType, String DeviceName, int PortNumber) throws android.os.RemoteException
{
...
@Override public int sendEscCommand(int PrinterId, String b64) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int sendLabelCommand(int PrinterId, String b64) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public String getClientID() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
String _result;
...
@Override public int setServerIP(String ip, int port) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public int openPort(int PrinterId, int PortType, String DeviceName, int PortNumber) throws android.os.RemoteException;
...
public int sendEscCommand(int PrinterId, String b64) throws android.os.RemoteException;
public int sendLabelCommand(int PrinterId, String b64) throws android.os.RemoteException;
public void isUserExperience(boolean userExperience) throws android.os.RemoteException;
public String getClientID() throws android.os.RemoteException;
public int setServerIP(String ip, int port) throws android.os.RemoteException;
}
